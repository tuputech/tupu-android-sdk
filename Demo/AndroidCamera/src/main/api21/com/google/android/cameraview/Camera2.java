...
class Camera2 extends CameraViewImpl {
        ...
        public void onImageAvailable(ImageReader reader) {
            try (Image image = reader.acquireNextImage()) {
                ...
                if (planes.length > 0) {
                    ...
                    mCallback.onYUV420888FrameCallback(y_plane, u_plane, v_plane, pixelStride, image.getWidth(), image.getHeight());
                }
            }
        }
    ...
    /**
     * Locks the focus as the first step for a still data capture.
     */
